...
gvbt_replykeyboard.row('Статистика поломок общая','Статистика починок') # вторая строка меню
#gvbt_replykeyboard.row('Статистика поломок за месяц') # третья строка меню
